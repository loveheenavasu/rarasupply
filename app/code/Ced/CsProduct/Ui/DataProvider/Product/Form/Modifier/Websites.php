...
class Websites extends \Magento\Catalog\Ui\DataProvider\Product\Form\Modifier\AbstractModifier
{
    ...
    public function __construct(
        ...
        if(!$this->registry->registry('website_current_store_data'))
        $this->registry->register('website_current_store_data', $this->storeManager->getStore());
    ...
    public function modifyData(array $data)
    {
        ...
        if (!$this->storeManager->isSingleStoreMode() && $modelId) {
            ...
            foreach ($this->getWebsitesList() as $website) {
                ...
                if($this->registry->registry('website_current_store_data')->getWebsiteId()!=$website['id']) 
                   continue;
