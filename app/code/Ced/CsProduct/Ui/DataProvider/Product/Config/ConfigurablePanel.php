...
class ConfigurablePanel extends AbstractModifier
{
    ...
    public function modifyMeta(array $meta)
    {
        ...
        $allowdProductSet = $this->_scopeConfig->getValue('ced_vproducts/general/type',\Magento\Store\Model\ScopeInterface::SCOPE_STORE);
        $allowdProductSet = explode(',', $allowdProductSet);

        if (!in_array(ConfigurableType::TYPE_CODE, $allowdProductSet) || ($this->request->getParam('type') != ConfigurableType::TYPE_CODE && $model->getTypeId() != ConfigurableType::TYPE_CODE))
            return $meta;
