...
class Save extends \Ced\CsVendorProductAttribute\Controller\Attribute
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $vendorAttributeSets = $this->vendorAttributeSet->getProductAttributeSets($vendor_id)->getColumnValues('attribute_set_id');
            
            if(isset($data['attribute_set_ids']) && !empty(array_diff($data['attribute_set_ids'], $vendorAttributeSets))){
