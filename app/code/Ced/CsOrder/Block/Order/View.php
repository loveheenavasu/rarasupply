...
/**
 * Class View
 * @package Ced\CsOrder\Block\Order
 */
    ...
    protected function _construct()
    {
        ...
        foreach($order->getAllItems() as $item)
        {
            if($item->getParentItem()) 
                continue;
            $itemCollection = $this->_vtorders->getCollection()->addFieldToFilter('vendor_id', $vorder->getVendorId())
                              ->addFieldToFilter('parent_id',$vorder->getId())->addFieldToFilter('order_item_id', $item->getItemId());
