...
/**
 * Class ListBlock
 * @package Ced\CsVendorReview\Block\Vshops
 */
class ListBlock extends \Ced\CsMarketplace\Block\Vshops\ListBlock
{
    ...
    )
    {
        ...
        parent::__construct($imageHelper, $aclHelper, $magentoTaxHelper, $magentoDirectoryHelper, $layerResolver, $urlHelper, $vshop, $vendor, $csmarketplaceHelper, $prodListHelper, $context, $data);
    }
