 ...
 * CedCommerce
  ...
  */
namespace Ced\CsCmsPage\Helper\Wysiwyg;
...
class Images extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getStorageRootSubpath()
    {
        if ($vendorId = $this->customerSession->getVendorId()) {
            ...
            return 'cscmspage/'.$vendor['public_name'].'_'.$vendorId;
        }
        return 'cscmspage/default';
    }
    ...
    public function getImageHtmlDeclaration($filename, $renderAsTag = false)
    {
        ...
        if ($renderAsTag) {
            ...
            if ($this->isUsingStaticUrlsAllowed()) {
                ...
                $html = $this->urlInterface->getUrl(
                    'cscmspage/wysiwyg/directive',
                    [
