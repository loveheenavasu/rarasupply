...
namespace Ced\CsCmsPage\Model\Wysiwyg\Images;

use \Ced\CsCmsPage\Helper\Wysiwyg\Images;
    ...
    public function getFilesCollection($path, $type = null)
    {
        ...
        foreach ($collection as $item) {
            ...
            if ($this->isImage($item->getBasename())) {
                ...
                if (!$thumbUrl) {
                    $thumbUrl = $this->_backendUrl->getUrl('cscmspage/*/thumbnail', ['file' => $item->getId()]);
                }
