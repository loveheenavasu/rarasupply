...
namespace Ced\CsVendorAttribute\Helper;

/**
 * Eav data helper
 */
class Data extends \Magento\Eav\Helper\Data
{
    /**
     ...
     * @var string
     */
    const XML_PATH_VALIDATOR_DATA_INPUT_TYPES_ATTRIBUTE = 'ced_csvendorattribute/validator_data/input_types';
    ...
    {
    	if($this->moduleManager->isEnabled('Ced_CsVendorAttribute'))
    	{
    		return $this->scopeConfig->getValue(
    				self::XML_PATH_VALIDATOR_DATA_INPUT_TYPES_ATTRIBUTE,
