...
namespace Ced\CsVendorAttribute\Block\Adminhtml\Attributes\Edit\Options;
...
class Options extends \Magento\Backend\Block\Template
{
     ...
     * @var string
     */
    protected $_template = 'Ced_CsVendorAttribute::catalog/product/attribute/options.phtml';
