...
class Attribute extends \Magento\Eav\Model\Entity\Attribute
{
    ...
    protected $vendorFormCollection;
    ...
    public function __construct(
        ...
        \Ced\CsMarketplace\Model\ResourceModel\Vendor\Form\CollectionFactory $vendorFormCollection,
        ...
        $this->vendorFormCollection = $vendorFormCollection;
    ...
    public function _vendorForm($attribute)
    {
        ...
        $fields = $this->vendorFormCollection->create()
    ...
    public function getStoreWiseIds($storeId=0)
    {
        if($storeId) {
            $allowed=array();
            foreach($this->vendorFormCollection->create()
