...
class Data extends \Magento\Framework\App\Helper\AbstractHelper {
     ...
     * @var string
     */
    protected $_admin_send_email = 'admin_quote_submit_email_template';
    ...
    {   
        $support = $this->getConfigValue('trans_email/ident_support/email');
        $email = $customerEmail;
        ...
        try {
            ...
            //$this->sendPoCreatedMailToAdmin($this->_template, $emailvariables, $email);
     ...
     * @return \Magento\Framework\Phrase
     */
    public function sendEmail($template, $tempate_variables = [], $reciever_email){
