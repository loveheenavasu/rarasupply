    ...
    public function getFields() 
    {
        ...
        if (isset($fields['active']) && isset($fields['paypal_email'])) {
            ...
            $fields['active']['onchange'] =
                "if(this.value == '1') { document.getElementById('" . $this->getCode() . $this->getCodeSeparator() .
                "paypal_email').className = 'required-entry validate-email input-text';} else { document.getElementById('" .
