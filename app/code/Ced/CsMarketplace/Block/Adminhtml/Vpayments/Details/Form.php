    ...
    protected function loadFields()
    {
        ...
        if ($model->getCurrency() != $model->getBaseCurrency()) {
            ...
            $fieldsets = [
                ...
                'beneficiary_details' => [
                    'fields' => array(
                        'vendor_id' => array('label' => __('Vendor Name'), 'text' => $renderName->render($model),
                            'type' => 'note'),
                        'payment_code' => array('label' => __('Payment Method'), 'type' => 'label',
                            'value' => $model->getData('payment_code')),
                        'payment_detail' => array('label' => $other ? __('Payment Details') : __('Beneficiary Details'),
                            'type' => 'note',
                            'text' => $detail),
                    ),
                    'legend' => $other ? __('Payment Details') : __('Beneficiary Details')
                ...
                'payment_details' => array(
                    'fields' => array(
                        'transaction_id' => array('label' => __('Transaction ID#'), 'type' => 'label',
                            'value' => $model->getData('transaction_id')),
