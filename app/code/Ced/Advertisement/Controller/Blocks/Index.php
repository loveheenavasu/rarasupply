...
class Index extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute()
    {
        ...
        if ($navigationBlock) {
            $navigationBlock->setActive('advertisement/blocks/index');
        }    
        ...
        if ($block = $this->_view->getLayout()->getBlock('advertisement_block')) {
            $block->setRefererUrl($this->_redirect->getRefererUrl());
        }
        $this->_view->getPage()->getConfig()->getTitle()->set(__('Advertisement Blocks'));
