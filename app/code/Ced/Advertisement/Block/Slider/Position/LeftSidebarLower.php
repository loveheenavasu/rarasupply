 ...
 * @since 100.0.2
 */
class LeftSidebarLower extends \Magento\Framework\View\Element\Template
{
    /**
     * Constructor
     *
    ...
    public function sliderData(){
        ...
        $purchased = $this->_objectManager
                    ...
                    ->addFieldToFilter('position_identifier','show_ad_in_lower_left_sidebar')
                    ->addFieldToFilter('status', 1);
                
                //    print_r($purchased->getData());die;
