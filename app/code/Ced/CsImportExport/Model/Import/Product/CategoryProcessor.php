...
class CategoryProcessor
{
    ...
    public function upsertCategories($categoriesString, $categoriesSeparator)
    {
        ...
        $cat_mode = $this->csmarketplaceHelper->getStoreConfig('ced_vproducts/general/category_mode');
        if ($cat_mode) {
            $options = explode(",", $this->csmarketplaceHelper->getStoreConfig('ced_vproducts/general/category'));
