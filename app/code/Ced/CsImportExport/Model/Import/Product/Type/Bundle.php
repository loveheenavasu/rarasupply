 ...
 */
class Bundle extends \Ced\CsImportExport\Model\Import\Product\Type\AbstractType
{
        ...
        if ($this->_entityModel->getBehavior() == \Magento\ImportExport\Model\Import::BEHAVIOR_DELETE) {
            ...
            while ($bunch = $this->_entityModel->getNextBunch()) {
                foreach ($bunch as $rowNum => $rowData) {
                    ...
                    $productData = $newSku[strtolower($rowData[\Ced\CsImportExport\Model\Import\Product::COL_SKU])];
