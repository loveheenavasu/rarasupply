 ...
 */
class Downloadable extends \Ced\CsImportExport\Model\Import\Product\Type\AbstractType
{
    /**
     ...
     * @param \Ced\CsImportExport\Helper\Uploader $uploaderHelper
    ...
    public function __construct(
        \Ced\CsImportExport\Helper\Uploader $uploaderHelper,
    ...
    {
        parent::__construct($prodAttrColFac, $resource, $metadataPool, $params);
    ...
    public function saveData()
    {
        ...
        while ($bunch = $this->_entityModel->getNextBunch()) {
            foreach ($bunch as $rowNum => $rowData) {
                ...
                $rowSku = strtolower($rowData[Product::COL_SKU]);
