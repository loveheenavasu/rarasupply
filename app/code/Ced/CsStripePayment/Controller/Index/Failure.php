...
class Failure extends \Ced\CsMarketplace\Controller\Vendor
{
    ...
    {	
        ...
        $account_type = $this->_scopeConfig->getValue('payment/ced_csstripe_method_one/account_type');
