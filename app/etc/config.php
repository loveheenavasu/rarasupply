...
return [
    'modules' => [
        ...
        'Ced_CsDeal' => 1,
        'Ced_CsDhlshipping' => 1,
        'Ced_CsFedexShipping' => 1,
        'Ced_CsImportExport' => 1,
        'Ced_CsMarketplace' => 1,
        'Ced_CsMultiShipping' => 1,
        'Ced_CsTransaction' => 1,
        'Ced_CsProAssign' => 1,
        'Ced_CsProduct' => 1,
        'Ced_CsPurchaseOrder' => 1,
        'Ced_CsRfq' => 1,
        'Ced_CsRma' => 1,
        'StripeIntegration_Payments' => 1,
        'Ced_CsOrder' => 1,
        'Ced_CsVendorAttribute' => 1,
        'Ced_CsVendorProductAttribute' => 1,
        'Ced_CsVendorReview' => 1,
        'Ced_QuickOrder' => 1,
        'Ced_RequestToQuote' => 1,
        'Ced_Rewardsystem' => 1,
        'Ced_VendorsocialLogin' => 1,
